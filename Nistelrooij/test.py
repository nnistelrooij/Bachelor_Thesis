...
tau = np.linspace(0.6, 1.0, 10)
# tau = [0.8]
kappa_oto = np.linspace(sig2kap(1.4), sig2kap(3.0), 10)
# kappa_oto = [sig2kap(2.2)]
lapse = np.linspace(0.0, 0.1, 10)
# lapse = [0.02]
...
plotProbTable(rods, genAgent.prob_table)
...
for stim_selection in ['adaptive', 'random']:
    ...
    plotter = Plotter(iterations_num, params, params_gen)
